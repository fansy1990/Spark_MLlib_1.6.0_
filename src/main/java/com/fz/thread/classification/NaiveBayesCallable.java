 ...
 * @date 2017-2-20
 */
public class NaiveBayesCallable implements CallableWithArgs {
    private Logger log = LoggerFactory.getLogger(NaiveBayesCallable.class);
    private String appName = "Naive Bayes Train Model ";
    private String className = "com.fz.classification.CustomNaiveBayes";
